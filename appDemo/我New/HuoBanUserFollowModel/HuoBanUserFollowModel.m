...
@interface HuoBanUserFollowModel ()
@end
@implementation HuoBanUserFollowModel
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(dictionary[@"data"] != nil && [dictionary[@"data"] isKindOfClass:[NSArray class]]){
		...
		for(NSDictionary * dataDictionary in dataDictionaries){
			HuoBanUserFollowData * dataItem = [[HuoBanUserFollowData alloc] initWithDictionary:dataDictionary];
...
-(NSDictionary *)toDictionary
{
	...
	if(self.data != nil){
		...
		for(HuoBanUserFollowData * dataElement in self.data){
