...
@interface huobanUserFeedModel ()
@end
@implementation huobanUserFeedModel
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(dictionary[@"data"] != nil && [dictionary[@"data"] isKindOfClass:[NSArray class]]){
		...
		for(NSDictionary * dataDictionary in dataDictionaries){
			huobanUserFeedData * dataItem = [[huobanUserFeedData alloc] initWithDictionary:dataDictionary];
            
			[dataItems addObject:dataItem];
//            [dataItems addObject:dataDictionary];
...
-(NSDictionary *)toDictionary
{
	...
	if(self.data != nil){
		...
		for(huobanUserFeedData * dataElement in self.data){
